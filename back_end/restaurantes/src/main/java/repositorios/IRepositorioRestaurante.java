...
public interface IRepositorioRestaurante{
	...
	String create(String nombre, double latitud, double longitud, String ciudad, String fecha, String gestorId);
    
	Restaurante findById(String id) throws RepositorioException, EntidadNoEncontrada;
    
	List<ResumenRestaurante> findAll();
    
	boolean update(String idRestaurante, String nombre, double latitud, double longitud, String ciudad, String fecha) throws RepositorioException, EntidadNoEncontrada;
