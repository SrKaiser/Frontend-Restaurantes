...
public class RepositorioRestauranteMemoria implements IRepositorioRestaurante{
	...
	@Override
	public String create(String nombre, double latitud, double longitud, String ciudad, String fecha, String gestorId) {
...
//        restaurante.setOpinionId(opinionId);
	...
	@Override
	public boolean update(String idRestaurante, String nombre, double latitud, double longitud, String ciudad, String fecha) throws EntidadNoEncontrada {
