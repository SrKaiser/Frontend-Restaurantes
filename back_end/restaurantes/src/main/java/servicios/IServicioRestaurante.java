...
public interface IServicioRestaurante {
	...
	String altaRestaurante(String nombre, double latitud, double longitud, String ciudad, String fecha, String idGestor);
	
	boolean actualizarRestaurante(String id, String nombre, double latitud, double longitud, String ciudad, String fecha) throws RepositorioException, EntidadNoEncontrada;
