...
public class PruebasUnitarias {
	...
	public void testAltaRestaurante() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 10.0, 20.0, "Cartagena", "29-06-2001", "César");
	...
	public void testActualizarRestaurante() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 10.0, 20.0, "Cartagena", "29-06-2001", "César");
		boolean resultado = servicio.actualizarRestaurante(id, "Restaurante Actualizado", 30.0, 40.0, "Murcia", "29-06-2001");
	...
	public void testFindSitiosTuristicosProximos() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 40.42039145624014, -3.6996503622016954, "Cartagena", "César", "29-06-2001");
	...
	public void testAddPlato() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 10.0, 20.0, "Cartagena", "César", "29-06-2001");
		Plato plato = new Plato("Plato Test", "Descripcion Test", 10.0, true);
	...
	public void testUpdatePlato() throws RepositorioException, EntidadNoEncontrada {
		...
		Plato plato = new Plato("Plato Test", "Descripcion Test", 10.0, true);
		servicio.añadirPlato(id, plato);
		Plato platoActualizado = new Plato("Plato Test", "Descripcion Actualizada", 20.0, true);
	...
	public void testListarRestaurantes() throws RepositorioException, EntidadNoEncontrada {
		String id1 = servicio.altaRestaurante("Restaurante 1", 10.0, 20.0, "Cartagena", "César", "29-06-2001");
		servicio.añadirPlato(id1, new Plato("Plato Test 1", "Descripcion Test 1", 10.0, true));
		String id2 = servicio.altaRestaurante("Restaurante 2", 30.0, 40.0, "Cartagena", "César", "29-06-2001");
		servicio.añadirPlato(id2, new Plato("Plato Test 2", "Descripcion Test 2", 20.0, true));
	...
	public void testActualizarRestauranteNoEncontrado() throws EntidadNoEncontrada, RepositorioException {
		servicio.actualizarRestaurante("ID inexistente", "Nuevo Nombre", 50.0, 60.0, "Murcia", "29-06-2001");
	}

	@Test(expected = RepositorioException.class)
	public void testActualizarRestauranteLatitudInvalida() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 10.0, 20.0, "Cartagena", "César", "29-06-2001");
		servicio.actualizarRestaurante(id, "Restaurante Actualizado", 200.0, 40.0, "Murcia", "29-06-2001");
	}

	@Test(expected = RepositorioException.class)
	public void testActualizarRestauranteLongitudInvalida() throws RepositorioException, EntidadNoEncontrada {
		String id = servicio.altaRestaurante("Restaurante Test", 10.0, 20.0, "Cartagena", "César", "29-06-2001");
		servicio.actualizarRestaurante(id, "Restaurante Actualizado", 30.0, 200.0, "Murcia", "29-06-2001");
	}
	...
	public void testAñadirPlatoRestauranteNoEncontrado() throws EntidadNoEncontrada, RepositorioException {
		Plato plato = new Plato("Plato Test", "Descripción Test", 10.0, true);
